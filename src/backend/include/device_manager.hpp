...
public:
  ...
  template <TaskState State>
  mem_t add_mem(devid_t id, mem_t mem_)
  {
    auto &resources = get_resources<State>();
  ...
  template <TaskState State>
  mem_t remove_mem(devid_t id, mem_t mem_)
  {
    auto &resources = get_resources<State>();
  ...
  template <TaskState State>
  void remove_vcu(devid_t id, vcu_t vcu_)
  {
    auto &resources = get_resources<State>();
  ...
  template <TaskState State>
  void add_vcu(devid_t id, vcu_t vcu_)
  {
    auto &resources = get_resources<State>();

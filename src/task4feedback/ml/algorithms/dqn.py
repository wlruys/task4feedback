...
def run_dqn(
    ...
    qvalue_module.load_state_dict(
        torch.load(f"dqn_model_{147}.pth"),
        strict=False,
    )
    ...
    replay_buffer = TensorDictReplayBuffer(
        ...
        sampler=PrioritizedSampler(max_capacity=200_000, alpha=1, beta=1),
        # transform=r2g,
    )
    ...
    collector = SyncDataCollector(
        ...
        frames_per_batch=224 * 20,
        init_random_frames=224 * 10,
    )

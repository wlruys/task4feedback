...
class BatchTransitionConditions(TransitionConditions):
    def __init__(self, batch_size: int = 20, queue_threshold: int = 2, max_in_flight: int = 16) -> None: ...
...
class PlannedThresholdTransitionConditions(TransitionConditions):
    def __init__(self, planned_threshold: int = 1, max_reserved_threshold: int = 16) -> None: ...

    planned_threshold: int
    max_reserved_threshold: int
...
class METISMapper(EFTMapper):
    ...
    @overload
    def __init__(self, other: METISMapper) -> None: ...
...
class DARTSMapper(Mapper):
    ...
    @property
    def short_horizon_threshold(self) -> int: ...

    @short_horizon_threshold.setter
    def short_horizon_threshold(self, arg: int, /) -> None: ...

    @property
    def medium_horizon_threshold(self) -> int: ...

    @medium_horizon_threshold.setter
    def medium_horizon_threshold(self, arg: int, /) -> None: ...

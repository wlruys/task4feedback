...
void init_graph_ext(nb::module_ &m) {
  ...
  nb::class_<GraphManager>(m, "GraphManager")
      .def_static("finalize", &GraphManager::finalize, "tasks"_a, "create_data_tasks"_a = true,
                  "add_missing_writers"_a = false);
  ...
  nb::class_<GraphTemplate>(m, "GraphTemplate")
      ...
      .def("fill_dependencies_from_data_usage", &GraphTemplate::fill_dependencies_from_data_usage)

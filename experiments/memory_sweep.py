...
def test(cfg: DictConfig):
    ...
    def naive_mapper(graph):
        ...
        graph.mincut_per_levels(
            bandwidth=cfg.system.d2d_uni_bw * cfg.system.d2d_uni_links,
            mode="dynamic",
            offset=1,
    ...
    for single_gpu_mem_size in sweep_list:
        ...
        s = numa_devices(
            ...
            h2d_uni_bw=cfg.system.h2d_uni_bw,
    ...
    file_name += f"_bcr{cfg.graph.config.boundary_compute_ratio}_icr{cfg.graph.config.interior_compute_ratio}"

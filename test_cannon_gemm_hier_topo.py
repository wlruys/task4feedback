...
def test_data(n_gpus, blocks, n, p, hier_levels, data_size=None, m=None, energy=[0.01, 1, 100, 1000], dram=False):
    ...
    data_config = CannonGemmHierDataGraphConfig(hier_levels=hier_levels, levels=levels, blocks=blocks, energy=energy, n=n, a=a, p=p[0])
...
print(total_p)
dram = True
test_data(total_p, p_per_level, n, p, levels, energy=energy, dram=dram)

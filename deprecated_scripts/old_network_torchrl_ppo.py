...
class FastSimEnv(EnvBase):
    ...
    def _get_baseline(self):
        ...
        # assert final_state == trip.ExecutionState.COMPLETE, (
    ...
    def _step(self, td: TensorDict) -> TensorDict:
        ...
        actions = [
            trip.Action(local_id, device, reserving_priority, launching_priority)
        ]
        ...
        # terminated[0] = simulator_status == trip.ExecutionState.COMPLETE
        ...
        if not done:
            assert simulator_status == trip.ExecutionState.EXTERNAL_MAPPING, (

...
parser.add_argument(
    "-m", "--mode", type=str, help="testing, training, parla, loadbalance, random"
)
parser.add_argument(
...
parser.add_argument("-s", "--steps", type=int, help="chain steps", default=4)
parser.add_argument("-c", "--chains", type=int, help="chain chains", default=4)
parser.add_argument(
    "-o",
    "--sort",
    type=str,

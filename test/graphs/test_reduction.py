...
parser = argparse.ArgumentParser(prog="Reduction")
...
parser.add_argument("-l", "--levels", type=int, help="reduction tree levels", default=9)
parser.add_argument(
    "-b", "--branches", type=int, help="reduction tree branches", default=2
)
parser.add_argument(
    "-i",
